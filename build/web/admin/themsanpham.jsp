...
<head>
  ...
  alert("Thêm thành công!");
      ...
      alert("Thêm Th?t b?i! vui lòng ki?m tra l?i?");
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                   <li ><a href="#"><i class="fa fa-bullseye"></i> Dashboard</a></li>
                    ...
                    <li class="active"><a href="<%=request.getContextPath()%>/admin/themsanpham.jsp"><i class="fa fa-font"></i> Add Products</a></li>
                ...
                <div >              
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i>New Products</h3>
                        </div>
                 
                 <form action="<%=request.getContextPath()%>/themspServlet" method="POST">
<div>
            <label for="tensp" class="col-md-2">
                Product Name:
            </label>
            <div class="col-md-9">
                <input type="text" class="form-control" name="tensp" placeholder="Enter Name">
            </div>
        </div>        
        <div>
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="giatien" placeholder="Enter VND"  >
            </div>
        </div>
        <div>
            ...
            <div class="col-md-9">
                <input type="number" class="form-control" name="soluong" placeholder="Enter Number" >
            </div>
        </div>              
        <div>
