...
<html lang="en">
  ...
  alert("Thêm thành công!");
     ...
     else if(${thongbao1 == 'true'}){
  alert("Xóa thành công!");
  
}else if(${thongbao1 == 'false'}){
      alert("Xóa Thất bại! vui lòng kiểm tra lại?");
      
  }
     else if(${thongbao2 == 'true'}){
  alert("Sửa thành công!");
  
}else if(${thongbao2 == 'false'}){
...
<body>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active"><a href="<%=request.getContextPath()%>/admin/danhsachus"><i class="fa fa-globe"></i> List Users</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Users <small>List User</small></h1>
            ...
            <div class="row">
                <div class="col-lg-12">              
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i>Danh Sách Tài Khoản</h3>
                        </div>
                ...
                <c:forEach var="us" items="${listus}">
                    <tr>
                        <td><c:out value="${us.stt}" /></td>                         
                        <td><a style="color: blue" href="<%=request.getContextPath()%>/editnvServlet?username=<c:out value='${us.username}' />"><c:out value="${us.username}" /></a></td> 
			<td><c:out value="${us.password}" /></td> 
			<td><c:out value="${us.role}" /></td> 
                        <td><c:out value="${us.hoten}" /></td> 
                        <td><c:out value="${us.sdt}" /></td>
                        <td><c:out value="${us.diachi}" /></td>
                        <td><c:out value="${us.gioitinh}" /></td> 
                        <td><c:out value="${us.mail}" /></td> 
                        <td><a href="<%=request.getContextPath()%>/deleteuserServlet?use=<c:out value='${us.username}' />">Delete</a></td>      
                    </tr>
                </c:forEach>
